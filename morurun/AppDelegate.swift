...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        realmConfiguration.inMemoryIdentifier = Bundle.main.bundleIdentifier
        RLMRealmConfiguration.setDefault(realmConfiguration)
        self.realm = RLMRealm.default()
        
        self.userLocation.startTracking()
        
        self.window = UIWindow(frame: UIScreen.main.bounds)
        self.window?.rootViewController = SplashViewController(nibName: R.nib.splashView.name, bundle: nil)
